...
public class MobileLoad extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SMSSDK.initSDK(this, "2839cb4b272a6", "cbfe853cb76be819d9349911b9d9a721");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_login:
                ...
                if (strCode.length() == 4 && strCode != null) {
            ...
            case R.id.button_send_verification_code:
                ...
                if (strPhoneNumber==null||strPhoneNumber.length()!=11||"".equals(strPhoneNumber)){
